...
namespace TaskManagement.Application.Validation.Issue
{
    public class IssueUpdateDtoValidator : AbstractValidator<IssueUpdateDto>
    {
        ...
        public new Task<FluentValidation.Results.ValidationResult> ValidateAsync(IssueUpdateDto data, CancellationToken cancellationToken)
        {
