...
{
    public class EntityPrototypeUpdateDtoValidator : AbstractValidator<EntityPrototypeUpdateDto>
    {
        public EntityPrototypeUpdateDtoValidator()
        {
        ...
        public new Task<FluentValidation.Results.ValidationResult> ValidateAsync(EntityPrototypeUpdateDto data, CancellationToken cancellationToken)
        {
