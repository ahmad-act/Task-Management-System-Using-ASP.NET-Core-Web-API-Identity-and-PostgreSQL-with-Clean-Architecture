...
namespace TaskManagement.Application.Validation.Project
{
    public class ProjectCreateDtoValidator : AbstractValidator<ProjectCreateDto>
    {
        ...
        public new Task<FluentValidation.Results.ValidationResult> ValidateAsync(ProjectCreateDto data, CancellationToken cancellationToken)
        {
