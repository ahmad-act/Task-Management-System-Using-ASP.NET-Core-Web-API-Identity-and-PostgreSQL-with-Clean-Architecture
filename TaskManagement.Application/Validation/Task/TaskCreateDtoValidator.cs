...
namespace TaskManagement.Application.Validation.Task
{
    public class TaskCreateDtoValidator : AbstractValidator<TaskCreateDto>
    {
        ...
        public new Task<FluentValidation.Results.ValidationResult> ValidateAsync(TaskCreateDto data, CancellationToken cancellationToken)
        {
